...
<head>
  ...
  <title><?php echo isset($title)?$title:'Backpack';?></title>
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <a class="navbar-brand d-flex align-items-center justify-content-center" href="<?=base_url();?>">
            <div class="navbar-brand-text mx-3 text-gray-600">Backpack</div>
          </a>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Mamank Racing</span>
              </a>
